# Checks Report — cesu — 2026-06-14 11:54:32
...
```
2026-06-14T09:54:26Z	INFO	[vulndb] Need to update DB
2026-06-14T09:54:26Z	INFO	[vulndb] Downloading vulnerability DB...
2026-06-14T09:54:26Z	INFO	[vulndb] Downloading artifact...	repo="mirror.gcr.io/aquasec/trivy-db:2"
26.66 MiB / 96.06 MiB [---------------->____________________________________________] 27.76% ? p/s ?30.73 MiB / 96.06 MiB [------------------->_________________________________________] 31.99% ? p/s ?49.89 MiB / 96.06 MiB [------------------------------->_____________________________] 51.94% ? p/s ?83.27 MiB / 96.06 MiB [----------------------------------------->______] 86.68% 94.38 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 94.38 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 94.38 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 89.67 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 89.67 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 89.67 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 83.88 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 83.88 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 83.88 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 78.47 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 78.47 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 78.47 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 73.41 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 73.41 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 73.41 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 68.67 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [---------------------------------------------->] 100.00% 68.67 MiB p/s ETA 0s96.06 MiB / 96.06 MiB [-------------------------------------------------] 100.00% 24.99 MiB p/s 4.0s2026-06-14T09:54:30Z	INFO	[vulndb] Artifact successfully downloaded	repo="mirror.gcr.io/aquasec/trivy-db:2"
2026-06-14T09:54:30Z	INFO	[vuln] Vulnerability scanning is enabled
2026-06-14T09:54:30Z	INFO	Number of language-specific files	num=0
2026-06-14T09:54:30Z	WARN	[report] Supported files for scanner(s) not found.	scanners=[vuln]
...
[90m9:54AM[0m [32mINF[0m [1m20 commits scanned.[0m
[90m9:54AM[0m [32mINF[0m [1mscanned ~112632 bytes (112.63 KB) in 236ms[0m
[90m9:54AM[0m [32mINF[0m [1mno leaks found[0m
```
